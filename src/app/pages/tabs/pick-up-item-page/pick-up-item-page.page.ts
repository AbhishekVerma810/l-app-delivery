...
@Component({
  selector: 'app-pick-up-item-page',
  templateUrl: './pick-up-item-page.page.html',
  styleUrls: ['./pick-up-item-page.page.scss'],
})
export class PickUpItemPagePage implements OnInit {
  pendingOrders: any;
  orders: any;
  itemData: any;
